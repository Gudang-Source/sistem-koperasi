...
<table border="0" width="100%" align="center" class="table-parent">
    <tbody>
        ...
        <tr align="justify">
            <td colspan="2">
                <table>
                    ...
                    <tr>
                        <td valign="top">1.</td>
                        <td>Bunga Terhadap Kredit Installment / Reguler sebesar Rp. <?=number_format($detailPinjaman->row()->pokok_angsuran+$detailPinjaman->row()->bunga_angsuran)?>(<?=modules::run('admin/index/showTerbilang',$detailPinjaman->row()->pokok_angsuran+$detailPinjaman->row()->bunga_angsuran)?>) per bulan sejak tanggal penarikan sampai dengan pelunasan.</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td width="1082">Rp. <?=number_format($detailPinjaman->row()->pokok_angsuran)?></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Bunga:</td>
                                    <td>Rp. <?=number_format($detailPinjaman->row()->bunga_angsuran)?></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td class="border-dot">Lainnya:</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">Untuk sistem angsuran jasa. Pokok pinjaman sebesar Rp <?=number_format($detailPinjaman->row()->jumlah_pinjaman)?>(<?=modules::run('admin/index/showTerbilang',$detailPinjaman->row()->jumlah_pinjaman)?>) dibayar lunas pada saat jatuh tempo.</td>
                                </tr>
                                <tr align="center">
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    ?>
                                    <?=$tenggangWaktu[0]?>(<?=modules::run('admin/index/showTerbilang',$tenggangWaktu[0])?>) hingga batas waktu pelunasan berakhir.</td>
                                </tr>
                                <tr align="center">
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                    ...
                    <tr>
                        <td valign="top">2.</td>
                        <td>Administrasi 2% Rp. <?=number_format($detailPinjaman->row()->jumlah_pinjaman*(2/100))?>(<?=modules::run('admin/index/showTerbilang',$detailPinjaman->row()->jumlah_pinjaman*(2/100))?>)</td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        <td valign="top">3.</td>
                        <td>Provisi 1% Rp. <?=number_format($detailPinjaman->row()->jumlah_pinjaman*(1/100))?>(<?=modules::run('admin/index/showTerbilang',$detailPinjaman->row()->jumlah_pinjaman*(1/100))?>)</td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        <td valign="top">4. </td>
                        <td>Biaya materai secukupnya di bayar di muka Rp. <?=number_format($materai)?>(<?=modules::run('admin/index/showTerbilang',$materai)?>)</td>
                    </tr>
        ...
        <tr align="justify">
            <td colspan="2">
                Fasilitas Kredit Installment / Reguler tersebut diberikan untuk jangka waktu <?=$detailPinjaman->row()->jangka_waktu?> (<?=modules::run('admin/index/showTerbilang',$detailPinjaman->row()->jangka_waktu)?>) bulan, terhitung sejak tanggal <?=date('d-m-Y')?> sampai dengan <?=modules::run('admin/index/sumDate', date('Y-m-d'), $detailPinjaman->row()->jangka_waktu, 'month')?>
            </td>
        </tr>
        <tr align="center">
            <td colspan="2">&nbsp;</td>

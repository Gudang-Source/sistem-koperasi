  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form id="formbayarangsuran" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="#">
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Total Angsuran
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Denda <span class="required">*</span>
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" id="denda" required="required" class="form-control col-md-7 col-xs-12" name="denda">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            ...
            <!-- <a href="<?=base_url('admin/index/perpanjang_angsuran')?>" class="btn btn-warning">Perpanjang Angsuran</a> -->
          </div>
        </div>
...
$(document).ready(function() {
  $('#getData').on('click', function (e) {
    ...
    $.ajax({
      type: 'post',
      url: '<?=base_url('admin/index/getDetailAngsuran')?>',
      data: $('form').serialize(),
      success: function (i) {
        ...
        if(jsonObjectFinal.status == 'true'){
          ...
          document.getElementById("denda").value=jsonObjectFinal.data.denda;
  ...
  $('#formbayarangsuran').on('submit', function(e){
    ...
    $.ajax({
      type: 'post',
      url: '<?=base_url('admin/index/do_bayar')?>',
      data: $('form').serialize(),
      success: function (i) {
        var jsonObjectParse = JSON.parse(i);
        var jsonObjectStringify = JSON.stringify(jsonObjectParse);

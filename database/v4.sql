...
-- Membuang data untuk tabel koperasi.tm_anggota: ~1 rows (lebih kurang)
/*!40000 ALTER TABLE `tm_anggota` DISABLE KEYS */;
INSERT INTO `tm_anggota` (`kd_anggota`, `nama_anggota`, `alamat_anggota`, `no_hp`, `no_identitas`, `no_karyawan`, `tanggal_lahir`, `tanggal_masuk`, `tanggal_daftar`, `kd_user`) VALUES
	(1, 'Andrias Sofian Adinata', 'Moker', '0', '003', '122', '1992-09-29', '2016-10-05', '2016-10-05', 1);
...
-- Membuang data untuk tabel koperasi.tm_jaminan: ~2 rows (lebih kurang)
/*!40000 ALTER TABLE `tm_jaminan` DISABLE KEYS */;
INSERT INTO `tm_jaminan` (`kd_jaminan`, `kd_pinjaman`, `jaminan`, `no_surat`, `nopol`, `merk`, `tahun`, `warna`, `norangka`, `nomesin`, `atasnama`, `alamat`, `status`) VALUES
	(1, 1, 'BPKB', '1234567', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(21, 34, 'sertifikat', '12345', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
-- Membuang data untuk tabel koperasi.tm_pinjaman: ~4 rows (lebih kurang)
...
INSERT INTO `tm_pinjaman` (`kd_pinjaman`, `kd_anggota`, `jumlah_pinjaman`, `bunga`, `jenis_pinjaman`, `jangka_waktu`, `jaminan`, `pokok_angsuran`, `bunga_angsuran`, `tanggal_pinjam`, `provision`, `administrasi`, `status`, `kd_user`) VALUES
	...
	(34, 1, 900000, 2.5, 0, 3, 0, 300000, 22500, '2016-10-09', 9000, 18000, 0, 1);
...
-- Membuang data untuk tabel koperasi.tt_angsuran: ~17 rows (lebih kurang)
...
-- Membuang data untuk tabel koperasi.tt_bunga_tabungan: ~0 rows (lebih kurang)
